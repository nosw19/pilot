...
### 2. 폐결절 탐지 시스템
- **프로젝트 설명**: YOLO 모델을 사용하여 사진 속 폐결점을 탐지하는 시스템.
- **주요 기능**: 폐결절 자동탐지
- **관련 주피터 노트북**:
  - [구글 코렙 주피터 노트북] [https://colab.research.google.com/drive/1jUb-fbl90uqBEcV4tbw_Lf8D5CcuNsI2?usp=sharing](https://drive.google.com/file/d/1CfxYuQoPQxvYnOxViDn0ZbrCxyq5yhyF/view?usp=sharing)
